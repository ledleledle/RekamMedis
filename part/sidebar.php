  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="layout-default.html">Tambah Pegawai</a></li>
          <li><a class="nav-link" href="layout-transparent.html">Dokter</a></li>
          <li><a class="nav-link" href="layout-top-navigation.html">Apoteker</a></li>
        </ul>
      </li>
      <li><a class="nav-link" href="blank.html"><i class="fas fa-skull"></i> <span>Foto Rotgen</span></a></li>
      <li><a class="nav-link" href="blank.html"><i class="fas fa-bed"></i> <span>Rawat Inap</span></a></li>
